...
参考 https://github.com/Gillespie59/eslint-plugin-angular
...
module.exports = {
	...
	rules: {
		...
		'no-lone-blocks': 2,
		//不要把空格和tab混用
		// 'no-mixed-spaces-and-tabs': ["error", "smart-tabs"], // 为了对齐可以使用
		...
		'object-curly-spacing': [2, 'always', {
			"objectsInObjects": false, // 对象后面不用空格
			// "arraysInObjects": false  // 数组后面不用空格
		}],
		// 分号必须写在结尾
		"semi-style": [2, "last"],
