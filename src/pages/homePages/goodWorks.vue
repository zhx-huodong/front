                        ...
                        <div slot="header" class="clearfix">
                         ...
                         <div class="workContainer">
                             ...
                             <div class="workDetail">
                                 ...
                                 <p v-show="attachment.length!=0">作品附件:<a target="_blank" v-for="(item,index) in attachment[0]" :key="index" :href="item.url">{{item.title}}</a></p>
                             </div>
        ...
        async goodWorkDetail(){
            ...
            await this.axiosGet(params).then(res=>{
                ...
                if(res.attachment.length!=0){
                    that.attachment.push(res.attachment.map(res=>{
                        return {
                            "title":res.title,
                            "url":res.url,
                        }
...
<style lang="scss">
    #goodWorks{
        .el-card{
            min-height:600px;width:60%;margin:10px 20%;text-align:center;
        }
        .el-card__body{
            padding:50px 0;
        }
