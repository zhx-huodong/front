      ...
      <el-card style="min-height:650px;">
            ...
            <el-tabs v-model="activeName" @tab-click="handleClick">
                ...
                <el-tab-pane label="作品管理" name="third">
                  <div class="activity-lable">
                        <type-select 
                          :gradeList="gradeList" :activityProjectList="activityProjectList" :activityTypleList="activityTypleList" :regionList="regionList"
                          @gradeObject="gradeObject"  @activityProjectObject='activityProjectObject' @activityTypleObject="activityTypleObject" @regionObject='regionObject'
                        ></type-select>
                    </div>
                ...
                <el-tab-pane label="评审结果" name="fourth">
                  <div class="activity-lable">
                        <type-select 
                         :activityObjectList='gradeList2' :gradeList="gradeList3"
                        ></type-select>
                  </div>
...
import api from '../../service/api';
  export default {
    components: {EnrollInfo,WorksManagement,EvaluationResult,ActivityStatistics,TypeSelect,NewsBulletin},
    data() {
      return {
         parentMsg: 'father' ,
           gradeList:[
    ...
    // {{uri}}/activity/1?expand=detail,region,node,attachment,banner,category,categoryDetail
     ...
     async regionObject(val){
       ...
       console.log(val)
        ...
        async activeDeatil(){
          ...
          params.expand="detail,region,node,attachment,banner,category,categoryDetail"
